...
static const CYBLE_HIDSS_REPORT_T cyBle_hids1ReportArray[0x01u] = {
    {
        0x0023u, /* Handle of the Report characteristic value */ 
        0x0024u, /* Handle of the Client Characteristic Configuration descriptor */ 
        0x0025u, /* Handle of the Report Reference descriptor */ 
    },
};

const CYBLE_HIDSS_T cyBle_hidss[0x01u] = {
    {
        0x001Fu, /* Handle of the HID service */ 
        0x0021u, /* Handle of the Protocol Mode characteristic */ 
        0x01u, /* Number of report characteristics */ 
        cyBle_hids1ReportArray, /* Information about report characteristics */ 
        {
            {
                0x002Au, /* Handle of the Report characteristic value */ 
            ...
            {
                0x002Du, /* Handle of the Report characteristic value */ 
                CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Client Characteristic Configuration descriptor */ 
                CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Report Reference descriptor */ 
            },
            {
                0x002Fu, /* Handle of the Report characteristic value */ 
                0x0030u, /* Handle of the Client Characteristic Configuration descriptor */ 
                CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Report Reference descriptor */ 
            },
        }, /* Information about boot report characteristics */ 
        0x0027u, /* Handle of the Report Map characteristic */ 
        0x0028u, /* Handle of the Report Map External Report Reference descriptor */ 
        0x0032u, /* Handle of the HID Information characteristic */ 
        0x0034u, /* Handle of the HID Control Point characteristic */ 
    },
};
